'''
press together "alt + b" for BLUE
press together "alt + r" for RED
press together "alt + g" for GREEN

press together "ctrl + c" for Circle
press together "ctrl + r" for Rectangle
press together "ctrl + l" for Line

press together "ctrl + e" for erase

press "UP" for widht++
press "DOWN" for widht--
